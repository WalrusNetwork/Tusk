...
/**
 * Implementation of {@link AnvilTracker}.
 *
...
public class SimpleAnvilTracker extends AbstractTracker implements AnvilTracker {
  ...
  @Nullable
  public OfflinePlayer setOwner(
      @Nonnull FallingBlock anvil, @Nullable OfflinePlayer offlinePlayer) {
    Preconditions.checkNotNull(anvil, "anvil");
  ...
  public void clear(@Nonnull World world) {
    ...
    Iterator<Map.Entry<FallingBlock, OfflinePlayer>> entityIt =
        this.ownedAnvils.entrySet().iterator();
