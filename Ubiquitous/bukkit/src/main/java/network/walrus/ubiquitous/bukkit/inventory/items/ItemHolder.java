...
/**
 * A holder for {@link InventoryItem} inside of a {@link WalrusInventory}. Keeps track of what slot
...
public class ItemHolder {
   ...
   */
  public void putInInventory(Player player, Inventory bukkitInventory, WalrusInventory inventory) {
