...
/** Listener which passes information on to an {@link AnvilTracker}. */
...
public class AnvilListener implements Listener {
  ...
  public void onBlockPlace(BlockPlaceEvent event) {
    ...
    if (event.getBlock().getType() == Material.ANVIL) {
      this.tracker.setPlacer(
          event.getBlock(), Bukkit.getOfflinePlayer(event.getPlayer().getName()));
    }
  }
