...
/**
 * Common interface that all trackers should implement in order to track data in worlds.
 *
 * <p>It is important to control what data is tracked on a world basis, keeping in mind that worlds
 * may be loaded and unloaded at any time.
 *
...
public interface Tracker {
  ...
  /**
   * Indicates whether the tracker is enabled and collecting data in the specified world.
   *
   ...
   *
   * @return true if one or more worlds that were not enabled are now enabled, false otherwise
   */
  boolean enable();
   ...
   *
   * <p>Note that any data that was tracked will be discarded.
   *
   * @return true if one or more worlds that were enabled are now disabled, false otherwise
   */
  boolean disable();
