...
public class SimpleResolverManager implements DamageResolverManager {
  ...
  public void register(
      ...
      @Nonnull Collection<Class<? extends DamageResolver>> resolversBefore) {
    Preconditions.checkNotNull(resolver, "resolver");
        ...
        if (before.isEmpty()) {
          ...
          throw new IllegalArgumentException(
              "failed to solve constraints ("
                  ...
                  + loopEntry.resolver
                  + ") while obeying all other constraints");
        }
      }
    }
  ...
  public @Nonnull DamageInfo resolve(
