...
public class SimpleTrackerManager implements TrackerManager {
  ...
  private static @Nullable <T extends Tracker> T findTracker(
      @Nonnull Map<Class<? extends Tracker>, Tracker> db, @Nonnull Class<T> search) {
  ...
  @SuppressWarnings("unchecked")
  private static @Nullable <T extends Tracker> T setTrackerInDB(
      @Nonnull Map<Class<? extends Tracker>, Tracker> db,
      @Nonnull Class<T> trackerClass,
      @Nullable T tracker) {
    if (tracker != null) {
  ...
  public @Nullable <T extends Tracker> T setTracker(
      @Nonnull Class<T> trackerClass, @Nullable T tracker) {
    Preconditions.checkNotNull(trackerClass, "tracker class");
    Preconditions.checkArgument(
        trackerClass.isInstance(tracker), "tracker is not an instance of the specified class");
  ...
  @SuppressWarnings("unchecked")
  public @Nullable <T extends Tracker> T clearTracker(
