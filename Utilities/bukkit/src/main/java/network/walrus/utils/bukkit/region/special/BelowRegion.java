...
/**
 * Region which contains all vectors below the specified X, Y, and Z.
 *
...
public class BelowRegion implements Region {
   ...
   * Constructor.
   *
   * @param x coordinate to be used as the upper bound, or empty to ignore this axis
   * @param y coordinate to be used as the upper bound, or empty to ignore this axis
   * @param z coordinate to be used as the upper bound, or empty to ignore this axis
   */
  ...
  public String toString() {
    return "BelowRegion{" + "x=" + x + ", y=" + y + ", z=" + z + '}';
  }
}
