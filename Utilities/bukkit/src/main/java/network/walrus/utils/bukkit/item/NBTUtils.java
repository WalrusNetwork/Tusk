...
/**
 * Utilities for working with {@link NBTTagCompound}s.
 *
 * @author Overcast Network
 */
public class NBTUtils {

  private static final String KEY = "WALRUS_INFO";
   ...
   *
   * <p>This should be called after removing anything so that item stacking works properly.
   */
