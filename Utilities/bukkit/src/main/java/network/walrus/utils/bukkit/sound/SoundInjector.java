...
public class SoundInjector {
  ...
  static final ConfiguredSound $NULL$ = ConfiguredSound.create();
  private static final ConfiguredSound DEFAULT = ConfiguredSound.create();
   ...
   */
  public static void map(SoundBundle bundle, Class<?> clazz, String prefix) {
    try {
      for (Field field : clazz.getFields()) {
        ...
        if (field.get(null) == $NULL$) {
          ...
          Optional<ConfiguredSound> style = bundle.get(path);
